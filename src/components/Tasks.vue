    ...
    >
      ...
      <transition name="rotate" mode="out-in">
        <a
          ...
          class="tasks__item__button tasks__item__button--status"
          href="/"
        >
      ...
      <a href="/" @click.prevent="deleteTask(task['.key'])" class="tasks__item__button">
